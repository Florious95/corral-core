...
type Server struct {
	...
	// menu (requirement 060). The level2Loop polls only while this is > 0; at
	...
	// Distinct from listInterval so the live stream can be fresher than the
	// level-1 menu cadence.
