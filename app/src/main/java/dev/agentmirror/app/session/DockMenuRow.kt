 ...
 * - 图标 18dp + 13dp regular 文字，图文间距 7dp——符号在前保证「一眼可认」，
 *   文字兜底防歧义；
...
private fun MenuButton(
    ...
    Surface(
        ...
        Row(
            ...
            Icon(icon, contentDescription = null, modifier = Modifier.width(18.dp), tint = source.neutral200)
            Text(
                label,
                style = TextStyle(
