 ...
 * - [VISIBLE_FALLBACK]：候选字体全 miss 的内部信号；[GlyphRunBuilder] 将原码点改写为
 *   主等宽字体保证覆盖的 ASCII 可见替代，不把缺字码点继续交给 Canvas。
 */
enum class GlyphSlot { MONO, SYSTEM_FALLBACK, POWERLINE, VISIBLE_FALLBACK }
