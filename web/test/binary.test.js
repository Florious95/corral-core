...
import { decodeBinary, encodeBinary, BINARY_KIND } from '../js/binary.js';
import { ProtocolError } from '../js/protocol.js';

const ROOT = fileURLToPath(new URL('..', import.meta.url));
const FIXTURES = join(ROOT, '..', 'server', 'internal', 'protocol', 'testdata');
