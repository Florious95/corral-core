...
COMMIT = 'ff316dc0afe8ab280e61d30934e7624579be6224'
TREE = '5217a41aa914ddcb72c27f39f1b4af9ead68b1b6'
SYNC = ['Cargo.toml','Cargo.lock','src/classify.rs','src/lib.rs','src/main.rs','src/pi_activity.rs','src/proctree.rs','src/providers.rs','pi/nodeprobe-pi-activity.mjs','tests/fake_tmux.rs','tests/pi_extension.mjs','README.md','docs/api-architecture.md','docs/consumer-migration-map.md']
