# 知识基底 · fix-connected-idle-economy（tools/basegen.py 编译产物——手工编辑无效，重编请改素材源后重跑）
...
- librarian 撞库回执：.team/nodes/fix-connected-idle-economy/LIBRARIAN.md（先完整读）
...
- .team/nodes/fix-connected-idle-economy/FIELD.md（先完整读；含真机实证/失败现场/裁定）
