...
// frame codec. A periodic heartbeat re-scans and fans list_delta out to every
// live client; a reconnecting client re-auths, re-subscribes, and receives a
// fresh snapshot (requirement 004 stateless replay). The server keeps no
// client session state beyond the live connections.
package api
