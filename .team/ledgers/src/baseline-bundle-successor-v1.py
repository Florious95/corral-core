...
continuity_read_paths = [
    ".team/nodes/spec-sol/baseline-bundle-successor/任务书.md",
...
repro = Task(
    title="审计连续性 successor 首格：本账本 supersedes `ledger.baseline-bundle.v1` revision 1，但不重置其历史；按 successor 任务书与原 repro 任务书重新连续运行两次真实 probe，交 REPRO.json 固定 schema+REPRO.md；translator 只把完整 expected legacy red 转为 acceptance 0，probe 2 仍传 2，伪造/非预期为 1。不得改变旧 live/attempt、真实 ledger/emulator/daemon，产物齐后 report_result。",
    owner_role="repro", seat_wait_seconds=3600,
    resources=Resources(worktree_id="wt-bundle-core", write_paths=[".team/nodes/baseline-bundle-repro/"], read_paths=continuity_read_paths + [".team/nodes/spec-sol/baseline-bundle/任务书.md", ".team/nodes/spec-sol/baseline-bundle/repro-任务书.md", ".team/ledgers/perf-regress-v1.json", ".team/ledgers/perf-regress-v1.json.lease", ".team/nodes/_driver/perf-regress-v1.pid", ".team/ledgers/acceptance/perf-regress.sh", ".team/ledgers/acceptance/baseline-bundle-real-chain-probe.sh", ".team/ledgers/acceptance/baseline-bundle-repro-translate.sh", ".team/ledgers/acceptance/baseline-bundle-repro-regression.sh"], **base),
...
probe = Task(
    ...
    resources=Resources(worktree_id="wt-archive-probe", write_paths=[".team/nodes/baseline-bundle-probe/"], read_paths=continuity_read_paths + [".team/nodes/spec-sol/baseline-bundle/任务书.md", ".team/nodes/spec-sol/baseline-bundle/probe-任务书.md", ".team/nodes/baseline-bundle-repro/", ".team/nodes/baseline-bundle-prelaunch-review/PRELAUNCH-VERDICT.md", ".team/nodes/baseline-bundle-prelaunch-review/tmp/", ".team/nodes/input-full-auto/perf-design/CONTRACT.md", ".team/ledgers/acceptance/perf-regress.sh", ".team/ledgers/acceptance/baseline-bundle-probe.sh", ".team/nodes/pb-core/tmp/apksigner-verify.txt", "tools/perfbase/"], **base),
...
verify = Task(
    ...
    resources=Resources(worktree_id="wt-bundle-core", write_paths=[".team/nodes/baseline-bundle-verify/", ".team/nodes/spec-sol/baseline-bundle/tmp/"], read_paths=continuity_read_paths + [".team/nodes/spec-sol/baseline-bundle/任务书.md", ".team/nodes/spec-sol/baseline-bundle/verify-任务书.md", ".team/nodes/baseline-bundle-repro/", ".team/nodes/baseline-bundle-test/", ".team/nodes/baseline-bundle-probe/", ".team/nodes/baseline-bundle-impl/", ".team/nodes/baseline-bundle-prelaunch-review/tmp/", ".team/private/baseline-vault/", ".team/private/baseline-backup/", ".team/ledgers/acceptance/baseline-bundle-verify.sh", ".team/ledgers/acceptance/baseline-bundle-bypass-probes.sh", "tools/perfbase/", "app/"], **base),
...
user_gate = Task(
    ...
    resources=Resources(worktree_id="wt-bundle-core", write_paths=[".team/nodes/baseline-bundle-user/"], read_paths=continuity_read_paths + [".team/nodes/spec-sol/baseline-bundle/任务书.md", ".team/nodes/spec-sol/baseline-bundle/user-gate-任务书.md", ".team/nodes/baseline-bundle-impl/BUNDLE-MANIFEST.json", ".team/nodes/baseline-bundle-verify/", ".team/ledgers/acceptance/baseline-bundle-user-gate.sh"], **base),
...
migrate = Task(
    ...
    resources=Resources(worktree_id="wt-bundle-core", write_paths=[".team/nodes/baseline-bundle-migrate/", ".team/ledgers/src/perf-regress-v1.py", ".team/ledgers/perf-regress-v1.json", ".team/ledgers/perf-regress-v1.json.lease", ".team/nodes/_driver/perf-regress-v1.pid"], read_paths=continuity_read_paths + [".team/nodes/spec-sol/baseline-bundle/任务书.md", ".team/nodes/spec-sol/baseline-bundle/migrate-任务书.md", ".team/nodes/baseline-bundle-impl/", ".team/nodes/baseline-bundle-verify/", ".team/nodes/baseline-bundle-user/", ".team/nodes/perf-regress/FIXED-MEASURE.md", ".team/ledgers/acceptance/baseline-bundle-migrate.sh", "tools/perfbase/migrate-perf-regress.sh"], **base),
...
measure = Task(
    ...
    resources=Resources(worktree_id="wt-bundle-core", write_paths=[".team/nodes/baseline-bundle-measure/", ".team/private/baseline-candidates/", ".team/nodes/spec-sol/baseline-bundle/tmp/"], read_paths=continuity_read_paths + [".team/nodes/spec-sol/baseline-bundle/任务书.md", ".team/nodes/spec-sol/baseline-bundle/measure-任务书.md", ".team/nodes/baseline-bundle-impl/", ".team/nodes/baseline-bundle-verify/", ".team/nodes/baseline-bundle-user/", ".team/nodes/baseline-bundle-migrate/", ".team/nodes/baseline-bundle-prelaunch-review/tmp/", ".team/private/baseline-vault/", ".team/private/baseline-backup/", ".team/nodes/input-full-auto/perf-design/CONTRACT.md", ".team/ledgers/acceptance/baseline-bundle-measure.sh", ".team/ledgers/acceptance/baseline-bundle-bypass-probes.sh", "tools/perfbase/", "app/"], **base),
...
ledger = Ledger(
    ledger_id="ledger.baseline-bundle.successor.v1",
    roles=roles,
    tasks={
