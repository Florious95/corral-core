...
fun DockMenuRow(
    ...
    Row(
        ...
        MenuButton(DockIconKeyboard, "快捷键", onOpenHotkeys, Modifier.weight(1f))
        MenuButton(DockIconEye, "查看", onOpenViewMenu, Modifier.weight(1f))
        MenuButton(DockIconGrid, "会话", onOpenSessions, Modifier.weight(1f))
    }
}
